<x-app-layout>
     <div style="width: 80%; margin: 40px auto; background-color: #f7f7f7; padding: 20px; border: 1px solid #ddd; box-shadow: 0px 0px 10px rgba(0,0,0,0.1);">
       <form action="{{url('view_post')}}" method="get">
        @csrf
     <input type="submit" value="View my post"style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;background:green;">
        <br /><br />

        </form>
        <label style="width: 100%; padding: 10px;padding-bottom:5px; border: 1px solid #ccc; border-radius: 5px;">Write new post down here </label>
